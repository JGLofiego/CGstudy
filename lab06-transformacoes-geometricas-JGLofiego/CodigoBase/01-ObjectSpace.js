...
function buildScene() {
  ...
  cube.translateX(-0.7);
  cube.translateY(0.7);
  cube.rotateY(-Math.PI / 3.5 + 0.4);
  cube.rotateZ(-Math.PI / 7);
  // cube.rotateX(Math.PI/2.5)
  ...
  torusKnot.rotateY(-Math.PI / 7);
  torusKnot.rotateX(-Math.PI / 5);
  ...
  tetrahedron.translateY(-0.7);
  tetrahedron.rotateY(-Math.PI / 15);
  tetrahedron.rotateX(-Math.PI / 8);
  ...
  dodecahedron.translateY(-0.7);
  dodecahedron.rotateY(-Math.PI / 10);
  dodecahedron.rotateX(-Math.PI / 9);
}
